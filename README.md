...
README uses **PNG** because GitHub often blocks or fails to load **SVG** inside `<img>` tags. The PNGs are generated from the SVG sources in `docs/assets/`; regenerate after editing the SVGs:
